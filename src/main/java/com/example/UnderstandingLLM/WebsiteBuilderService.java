...
import com.example.UnderstandingLLM.aiTools.WebsiteTools;
...
public class WebsiteBuilderService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            8. Finish only when the complete website has been created.
            """;

    public String generate(String message) {

        System.out.println("WebsiteBuilder called....");
